...
const Header = () => {
  ...
  return <div className="grid justify-items-stretch">
      <div div className="justify-self-center text-white font-mono font-bold text-2xl tracking-wide">{username}</div>
      ...
      <div className="justify-self-center text-emerald-200 font-mono font-bold text-xl tracking-tighter"><Link to={`/${username}`}>Go to User</Link></div>
  </div>
}
